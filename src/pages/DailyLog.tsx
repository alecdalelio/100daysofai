      ...
      <div className="px-6 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-12">
            {entries.map((entry) => (
              <Card key={entry.day} className="glow-primary group">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl group-hover:gradient-text-cyber transition-all duration-300">
                    {entry.title}
                  </CardTitle>
                </CardHeader>
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-4 p-4 rounded-lg bg-accent/20 border border-border">
              <span className="text-sm text-muted-foreground">Progress</span>
              <div className="w-32 h-2 bg-muted rounded-full overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-electric to-cyber transition-all duration-500"
                  style={{ width: `${(3 / 100) * 100}%` }}
                />
              </div>
              <span className="text-sm font-medium">3/100 days</span>
            </div>
          </div>
        </div>
      </div>
